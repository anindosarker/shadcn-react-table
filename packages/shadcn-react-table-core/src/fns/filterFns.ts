...
import { type SRT_RowData } from '../types';
...
const contains = <TData extends SRT_RowData>(
  row: Row<TData>,
  id: string,
  filterValue: number | string,
): boolean =>
...
const startsWith = <TData extends SRT_RowData>(
  row: Row<TData>,
  id: string,
  filterValue: number | string,
): boolean =>
...
const endsWith = <TData extends SRT_RowData>(
  row: Row<TData>,
  id: string,
  filterValue: number | string,
): boolean =>
...
const equals = <TData extends SRT_RowData>(
  row: Row<TData>,
  id: string,
  filterValue: number | string,
): boolean =>
...
const notEquals = <TData extends SRT_RowData>(
  row: Row<TData>,
  id: string,
  filterValue: number | string,
): boolean =>
...
const greaterThan = <TData extends SRT_RowData>(
  row: Row<TData>,
  id: string,
  filterValue: number | string,
): boolean =>
...
const lessThan = <TData extends SRT_RowData>(
  row: Row<TData>,
  id: string,
  filterValue: number | string,
): boolean =>
...
const empty = <TData extends SRT_RowData>(
  row: Row<TData>,
  id: string,
...
const notEmpty = <TData extends SRT_RowData>(
  row: Row<TData>,
  id: string,
  _filterValue: number | string,
): boolean => !!row.getValue<number | string | null>(id)?.toString().trim();
