...
export const isCellEditable = <TData extends SRT_RowData>({
  cell,
  table,
}: {
  cell: SRT_Cell<TData>;
...
export const openEditingCell = <TData extends SRT_RowData>({
  cell,
  table,
}: {
  cell: SRT_Cell<TData>;
...
export const cellKeyboardShortcuts = <TData extends SRT_RowData = SRT_RowData>({
  cell,
  cellElements,
  cellValue,
  containerElement,
